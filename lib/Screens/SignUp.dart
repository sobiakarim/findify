...
import 'package:businessinfoapp/Screens/home.dart';
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        child: Column(
                          children: [
                            CircleAvatar(
                              ...
                              child: image == null
                                  ? const Icon(Icons.add_a_photo, size: 50, color: Color(0xffD3B08F),)
                                  : null,
                            ),
                            Text("Add Profile Picture", style: TextStyle(color: Color(0xffD3B08F),),)
                          ],
                        ),
                      ),
                    ),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        prefixIcon: Icon(Icons.person,  color: Color(0xffD3B08F),),
                        hintText: "Name",
                        hintStyle: TextStyle(color: Color(0xffD3B08F)),
                        enabledBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(20),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        prefixIcon: Icon(Icons.location_city, color: Color(0xffD3B08F),),
                        hintText: "City",
                        hintStyle: TextStyle(color: Color(0xffD3B08F)),
                        enabledBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(20),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        prefixIcon: Icon(Icons.maps_home_work_outlined, color: Color(0xffD3B08F),),
                        hintText: "Address",
                        hintStyle: TextStyle(color: Color(0xffD3B08F)),
                        enabledBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(20),
                      ...
                      child: Container(
                        ...
                        child: TextButton(
                          ...
                          style: TextButton.styleFrom(
                            side: BorderSide(color:  Color(0xffD3B08F )),
                          ),
                          child: Text("Sign Up", style: TextStyle(color: Color(0xffD3B08F),)),
                        ),
                      ),
                    ),
                    TextButton(
